...
public class Levels {
	...
	public void mark() {
		...
		if(timer >= 50) {
			...
			//level 1
			if(level == 2) {
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/2),0,ID.RenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/2)+width/2,0,ID.NonrenewableEnergy));
			} else if (level == 7) {
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/2)+width/2,0,ID.RenewableEnergy));
			...
			// level 2
				...
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/3)+width/3,0,ID.RenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/3)+2*width/3,0,ID.NonrenewableEnergy));
			} else if (level == 34) {
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/3),0,ID.RenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/3)+width/3,0,ID.NonrenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/3)+2*width/3,0,ID.NonrenewableEnergy));
			} else if (level == 38) {
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/3),0,ID.NonrenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/3)+width/3,0,ID.NonrenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/3)+2*width/3,0,ID.RenewableEnergy));
			} else if (level == 42) {
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/3),0,ID.RenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/3)+width/3,0,ID.NonrenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/3)+2*width/3,0,ID.NonrenewableEnergy));
			...
			//level 3
				...
				Header.LEVEL++;
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/4),0,ID.RenewableEnergy));
				...
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/4)+width/4,0,ID.RenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4)+width/2,0,ID.NonrenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4)+3*width/4,0,ID.NonrenewableEnergy));
			} else if (level == 61) {
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4),0,ID.NonrenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4)+width/4,0,ID.NonrenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/4)+width/2,0,ID.RenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4)+3*width/4,0,ID.NonrenewableEnergy));
			} else if (level == 64) {
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4),0,ID.NonrenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4)+width/4,0,ID.NonrenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4)+width/2,0,ID.NonrenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/4)+3*width/4,0,ID.RenewableEnergy));
			} else if (level == 67) {
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4),0,ID.NonrenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/4)+width/4,0,ID.RenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4)+width/2,0,ID.NonrenewableEnergy));
				...
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4),0,ID.NonrenewableEnergy));
				updater.addObjects(new NonrenewableEnergy(numGen.nextInt(width/4)+width/4,0,ID.NonrenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/4)+width/2,0,ID.NonrenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/4)+3*width/4,0,ID.RenewableEnergy));
			} else if (level == 73) {
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/4),0,ID.RenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/4)+width/4,0,ID.RenewableEnergy));
			...
			//level 4
				...
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/5)+width/5,0,ID.RenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/5)+2*width/5,0,ID.RenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/5)+3*width/5,0,ID.RenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/5)+4*width/5,0,ID.RenewableEnergy));
			} else if (level == 83) {
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/5),0,ID.RenewableEnergy));
			...
			//level 5
				...
				Header.LEVEL++;
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/6),0,ID.RenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/6)+width/6,0,ID.RenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/6)+2*width/6,0,ID.RenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/6)+3*width/6,0,ID.RenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/6)+4*width/6,0,ID.RenewableEnergy));
				...
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/6+5*width/6),0,ID.RenewableEnergy));
			} else if (level == 114) {
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/6),0,ID.RenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/6)+width/6,0,ID.RenewableEnergy));
				updater.addObjects(new RenewableEnergy(numGen.nextInt(width/6)+2*width/6,0,ID.RenewableEnergy));
